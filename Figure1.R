#For Figure 1 LSA abstract.Includes title, scales by percentage, only includes means & no error bars and etc.
...
Percentages <- c(.6742,.5954,.6091,.6859) #move decimal points over b/c scale continuous will multiply by 100
...
print(MacsPlot+ labs(y = "Percentage Rating", x = "Voice Language")) + ggtitle("Figure 1: Percentage Ratings by Question Group & Voice Language")


##data pooled by age and gender and converted to percentage