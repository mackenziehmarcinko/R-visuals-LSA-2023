#For Figure 2 LSA abstract.Includes title, scales by percentage, only includes means & no error bars and etc.
...
Percentages <- c(.690,.614,.621,.693) #move decimal points over b/c scale continuous will multiply by 100
...
##data pooled by gender, young participants only
##